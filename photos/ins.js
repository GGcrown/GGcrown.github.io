    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          //var minSrc = 'https://ggcrown.github.io/photos/picture/' + data.link[i] + '.min.jpg';
          var minSrc = 'https://ggcrown.github.io/photos/picture/' + data.link[i] + '.JPG';
          var src = 'https://ggcrown.github.io/photos/picture/' + data.link[i];
          var type = data.type[i];
          var myPhoto = data.link[i]+"."+data.type[i];
          console.log(myPhoto);
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="640x640" data-type="' + type + '" data-target="' + target + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/photos/picture/' + myPhoto + '" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
